...
class Table {
    ...
    */
    function addTSection($sec, $class = '', $attr_ar = array() ) {
        switch ($sec) {
            case 'thead':
                $ref = &$this->thead;
                break;
    ...
    function addColgroup($span = '', $class = '', $attr_ar = array() ) {
        $group = array(
            'span' => $span,
            'klass' => $class,
            'atts' => $attr_ar,
    ...
    function addCol($span = '', $class = '', $attr_ar = array()) {
        $col = array(
            'span' => $span,
            'klass' => $class,
            'atts' => $attr_ar
    ...
    private function getSection($sec, $tag) {
        $class = !empty($sec['klass'])? " class=\"{$sec['klass']}\"": '';
