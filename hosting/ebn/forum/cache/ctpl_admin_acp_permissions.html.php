...
<?php } if ($this->_rootref['S_SELECT_VICTIM']) {  if ($this->_rootref['U_BACK']) {  ?><a href="<?php echo (isset($this->_rootref['U_BACK'])) ? $this->_rootref['U_BACK'] : ''; ?>" style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;">&laquo; <?php echo ((isset($this->_rootref['L_BACK'])) ? $this->_rootref['L_BACK'] : ((isset($user->lang['BACK'])) ? $user->lang['BACK'] : '{ BACK }')); ?></a><?php } ?>
	...
	<script type="text/javascript" src="style/tooltip.jssrc=""></script>
